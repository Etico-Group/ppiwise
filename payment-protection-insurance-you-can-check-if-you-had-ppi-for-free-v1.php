  ...
  <div class="container">
      <div class="row">
            ...
            <div class="articles-box" style="border:none;">
                ...
                <div class="row"><div class="col-sm-10 col-sm-offset-1">
                  <picture>
                    ...
                    <a href="http://eticotrack.com/path/out.php?sxid=<?php echo (isset($_GET['sxid'])) ? $_GET['sxid'] : 0 ?>">
                  ...
                  <!-- <a href="http://eticotrack.com/path/out.php?sxid=<?php echo (isset($_GET['sxid'])) ? $_GET['sxid'] : 0 ?>"><img src="./images/c1d847fe-stressed_0ka0dk0ka0dj000000.png" alt="" class="img-responsive img-rounded" style="margin-bottom: 25px;"> -->
                </div>
            </div>
                <div class="text-center" style="font-size:14px;"><a href="https://eticotrack.com/path/out.php?sxid=<?php echo (isset($_GET['sxid'])) ? $_GET['sxid'] : 0 ?>">You Can Check if You've Had PPI for FREE Here</a></div>
                ...
                <div class="apply-btn">
                  ...
                  <a href="https://eticotrack.com/path/out.php?sxid=<?php echo (isset($_GET['sxid'])) ? $_GET['sxid'] : 0 ?>" class="btn btn-green">Start your FREE PPI Check</a>        
         ...
         // $show_start_ppi_check_btn_2 = true;
          ...
          <!-- <div class="container">
            <div class="row">
              <div class="col-xs-12 col-lg-12 text-center"><<a href="https://eticotrack.com/path/out.php?sxid=<?php echo (isset($_GET['sxid'])) ? $_GET['sxid'] : 0 ?>"><img src="./images/start-btn.png" class="img-responsive img-ppi-free" style="display: inline-block;margin-bottom: 15px;"></a><br></div>
            </div>
          </div> -->
...
<?php 
$include_feefo_tracking = true;
include('../includes/beforeslashbody.php');
?>
</body>
